...
<table class="sub_table" cellspacing="0" cellpadding="0" border="0" width="100%">
<tr><td><input id="input_name" type="text" name="nn" size="30" value="navn"/></td></tr>
<tr><td><input id="input_mail" type="text" name="ne" size="30" value="e-post"/></td></tr>
<tr><td colspan="2"><input class="submit_it" type="submit" value="Meld meg på"/></td></tr>
</table>
</form>';
